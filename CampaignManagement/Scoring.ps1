...
$ans = Read-Host 'Creating Scored Dataset. Do You Want to Continue - Yes [y|Y], No [n|N]?'
...
try 
	{
	$allsqlFiles=Get-ChildItem $filePath"\SQLR" -Filter step7*.sql
	...
	{
		Write-Host -ForegroundColor DarkYellow "Exception While Loading step7*.sql Files:" 
