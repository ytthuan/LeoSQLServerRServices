...
if ($WindowsORSQLAuthenticationFlag -eq "YES")
{
	...
	sqlcmd.exe -S $SqlServer -E -i $sqlFile2 -d $dbName -o $logFile
	sqlcmd.exe -S $SqlServer -E -i $sqlFile3 -d $dbName -o $logFile 
	sqlcmd.exe -S $SqlServer -E -i $sqlFile4 -d $dbName -o $logFile 
	sqlcmd.exe -S $SqlServer -E -i $sqlFile5 -d $dbName -o $logFile 
	sqlcmd.exe -S $SqlServer -E -i $sqlFile6 -d $dbName -o $logFile 
	sqlcmd.exe -S $SqlServer -E -i $sqlFile7 -d $dbName -o $logFile 
	sqlcmd.exe -S $SqlServer -E -i $sqlFile8 -d $dbName -o $logFile 
	sqlcmd.exe -S $SqlServer -E -i $sqlFile9 -d $dbName -o $logFile    	
}
else{
	...
	sqlcmd.exe -S $SqlServer -U $global:userName -P $global:passWord -i $sqlFile2 -d $dbName -o $logFile
	sqlcmd.exe -S $SqlServer -U $global:userName -P $global:passWord -i $sqlFile3 -d $dbName -o $logFile
	sqlcmd.exe -S $SqlServer -U $global:userName -P $global:passWord -i $sqlFile4 -d $dbName -o $logFile
	sqlcmd.exe -S $SqlServer -U $global:userName -P $global:passWord -i $sqlFile5 -d $dbName -o $logFile
	sqlcmd.exe -S $SqlServer -U $global:userName -P $global:passWord -i $sqlFile6 -d $dbName -o $logFile
	sqlcmd.exe -S $SqlServer -U $global:userName -P $global:passWord -i $sqlFile7 -d $dbName -o $logFile
	sqlcmd.exe -S $SqlServer -U $global:userName -P $global:passWord -i $sqlFile8 -d $dbName -o $logFile
	sqlcmd.exe -S $SqlServer -U $global:userName -P $global:passWord -i $sqlFile9 -d $dbName -o $logFile  	
}
